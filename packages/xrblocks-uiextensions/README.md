...
IWSDK does this internally, which is why panels look right there with no
setup. **A hand-rolled three.js host must do it explicitly**, and under XR
Blocks you should apply it to the renderer `xb.init()` creates.
