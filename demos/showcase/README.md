...
Demo client for the UI Extensions: six windows and two dock regions exercising the library's whole surface, including one window with every title-bar button on, one with none, and one driven from a hand-menu stand-in. The [workspace README](../../README.md#the-showcase-scene) has the tour.
